...
All Data is under script so unable to get links****
'''
...
class IdeelSpider(CrawlSpider):
  name = "ideel"
  allowed_domains = ['ideel.com']
  start_urls = ['http://www.ideel.com/']
  rules = (
    # Extract the different pages on the main site.
    Rule(SgmlLinkExtractor(restrict_xpaths='//li[@class="category_item"]')),
