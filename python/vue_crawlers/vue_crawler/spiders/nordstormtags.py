...
class NordStormProductTagsSpider(CrawlSpider):
  ...
  rules = (
    ...
    Rule(SgmlLinkExtractor(restrict_xpaths='//div[@class="filter category" or @class="filter standard size" or @class="filter standard color small" or @class="filter standard"]//li'),callback='parse_item'),
